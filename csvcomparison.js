            ...
            .on("end", () => {
                ...
                secondaryFileReadstream
                    ...
                    .on("end", () => {
                        ...
                        const internLines = baseFileContent
                            .toString()
                            .split("\n");
                        const externLines = secondaryFileContent
                            .toString()
                            .split("\n");
...
(async () => {
    ...
    console.log(
        await generateDeltaFile("./base-file.csv", "./secondary-file.csv")
    );
